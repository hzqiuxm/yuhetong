...
(function() {
  ...
  Simditor = (function(_super) {
    ...
    Simditor.prototype._render = function() {
      ...
      if (this.opts.params) {
        $(".simditor-body").height($(".simditor-wrapper").height()-72);
  ...
  CenterButton = (function(_super) {
    ...
    function CenterButton() {
      _ref2 = CenterButton.__super__.constructor.apply(this, arguments);
      return _ref2;
    }

    CenterButton.prototype.name = 'center';

    CenterButton.prototype.icon = 'bold';

    CenterButton.prototype.title = '文字居中';

    CenterButton.prototype.htmlTag = 'center';

    CenterButton.prototype.disableTag = 'pre';


    CenterButton.prototype.status = function($node) {
      var active;
      if ($node != null) {
        this.setDisabled($node.is(this.disableTag));
      }
      ...
      active = document.queryCommandState('JustifyCenter') === true;
      this.setActive(active);
      return active;
    };

    CenterButton.prototype.command = function($node) {
